...
function generate_scripts() 
{
	...
	// Fontawesome
	wp_enqueue_script( 'fontawesome', "https://use.fontawesome.com/64bc44c6e6.js", array( 'jquery' ), GENERATE_VERSION, true );

	// Google fonts
	wp_enqueue_style( 'google-fonts-css', "https://fonts.googleapis.com/css?family=Montserrat:400,600,700,800", false, GENERATE_VERSION, 'all' );
